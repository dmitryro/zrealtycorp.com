...
#    url(r'^users/(?P<username>.+)/$', views.UserViewSet.as_view({
 ...
 #   )),
    ...
    url(r'^comment/$', ('pages.views.add_comment')),
    ...
    url(r'^accounts/login/',RedirectView.as_view(url='/dashboard/')),
    url(r'^rest/$', RedirectView.as_view(url='/rest/login')),
    url(r'^dashboard/$', ('api.views.google_force')),
    ...
    url(r'^login/$',('api.views.google_force')),
    #url(r'^login/(?P<code>\w+)/$',('api.views.google_force')),
